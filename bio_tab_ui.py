...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_fluorescence_image = QtWidgets.QWidget()
        self.tab_fluorescence_image.setObjectName("tab_fluorescence_image")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.tab_fluorescence_image)
        self.horizontalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout()
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.fluorescence_image_canvas = bio_widget.MyMplCanvas()
        self.fluorescence_image_toolbar = NavigationToolbar(self.fluorescence_image_canvas, self)
        self.verticalLayout_10.addWidget(self.fluorescence_image_toolbar)
        self.verticalLayout_10.addWidget(self.fluorescence_image_canvas)
        self.horizontalLayout_10.addLayout(self.verticalLayout_10)
        self.ImgShowWidget.addTab(self.tab_fluorescence_image, "")        
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ImgShowWidget.setTabText(self.ImgShowWidget.indexOf(self.tab_fluorescence_image), _translate("MainWindow", "Fluorescence Image"))
